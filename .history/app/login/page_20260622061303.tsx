...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        formData.email === "admin@hypaedu.com" &&
        formData.password === "Hypa@123"
      ) {
        ...
        setLoginError(
          "Invalid email or password. Try admin@hypaedu.com / Hypa@123",
        );
      }
    } catch (error) {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-blue-50 rounded-xl p-4">
              ...
              <div className="space-y-1 text-sm text-blue-700">
                <p>Email: admin@hypaedu.com</p>
                <p>Password: Hypa@123</p>
              </div>
            </div>
          </form>
