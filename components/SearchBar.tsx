...
const SearchBar = ({ isOpen, onClose }: SearchBarProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute top-0 left-0 right-0 bg-white bg-opacity-95 backdrop-blur-md shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="flex-1 max-w-4xl mx-auto">
              <div className="relative">
                <input
                  ...
                  className="w-full px-6 py-4 text-lg border-0 focus:ring-0 focus:outline-none rounded-lg bg-gray-50 bg-opacity-50"
                />
